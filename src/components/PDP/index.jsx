...
const PDP = (props) => {
  ...
  useEffect(() => {
    let arr = Array.from({ length: props.location.state.product.stock }, (_, i) => i + 1);
    setProduct({ ...props.location.state.product, stock: arr });
              ...
              <div className="mt-6">
                <div className="mt-10 flex sm:flex-col1">
                  ...
                  {product.stock.length === 0 ? (
                    ...
                    >
                      {isLoggedIn ? "Agregar al carrito" : "Iniciar sesion"}
                    </button>
                  )}
                </div>
              </div>
